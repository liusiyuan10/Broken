...
- (void)drawRect:(CGRect)rect {
    ...
    for (int i = 0; i < self.dataArray.count; i ++) {
        ...
        // 6.小圆的中心点
        CGFloat xx = self.frame.size.width /3 ;
        CGFloat yy = self.frame.size.height / 3 + i * 20;

        
        // 7.画折线
        [self addLineAndnumber:model.color andCGContextRef:ctx andX:xx andY:yy andInt:i angele:0];
...
//        textStartY = smallCircleCenterPointY;
//
//        // 数字
//        numberStartX = textStartX  + numberSize.width;
